...
# Demonstration Test Case: How we can use table methods
def test_lesson_18_table_values_displaying(app):
    ...
    # Get list of column data values -> ['1','2','3'...]
    ...
    # Get list value from the specific colum by index -> 'Mark'
    ...
    # For loop for clicking each column value as check box for example
